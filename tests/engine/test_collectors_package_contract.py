...
def test_service_first_import_does_not_create_a_collector_cycle():
    import subprocess
    import sys
    result = subprocess.run([sys.executable, "-c", "import services.investor_trend_5day_service; from engine import KRXCollector; from engine.collectors.krx import KRXCollector as direct; assert KRXCollector is direct"], capture_output=True, text=True, timeout=15)
