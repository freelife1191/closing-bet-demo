---
name: logo-thumbnail-prompt-designer
...
## Quick Commands
- `./scripts/pipeline/run_stage.sh validate # placeholder for logo-thumbnail-prompt-designer`

## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills logo-thumbnail-prompt-designer`
