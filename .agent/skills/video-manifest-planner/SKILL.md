...
## Mission
Operate and verify the video-manifest-planner workflow with deterministic outputs.
...
## Quick Commands
- `./scripts/pipeline/run_stage.sh validate # placeholder for video-manifest-planner`

## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills video-manifest-planner`
