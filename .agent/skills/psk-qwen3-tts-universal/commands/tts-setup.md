---
name: tts-setup
description: Install and wire up psk-qwen3-tts-universal for cross-platform local usage.
...
## Verify
```bash
bash .agent/skills/psk-qwen3-tts-universal/scripts/smoke_test_qwen3_tts.sh --mode custom_voice
```
