---
name: qwen3-tts-m1-local
description: Use when legacy compatibility wrapper for the old Apple Silicon-focused Qwen3-TTS skill. Prefer `qwen3-tts-universal` for cross-platform setup and runtime
...
## Mission
Operate and verify the qwen3-tts-m1-local workflow with deterministic outputs.
...
## Quick Commands
- `bash
bash .agent/skills/qwen3-tts-m1-local/scripts/install_qwen3_tts_m1.sh
bash .agent/skills/qwen3-tts-m1-local/scripts/smoke_test_qwen3_tts.sh`

## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills qwen3-tts-m1-local`
