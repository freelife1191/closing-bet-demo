---
name: psk-video-copywriter-docs
...
## Quick Commands
- `./scripts/pipeline/run_stage.sh validate # placeholder for psk-video-copywriter-docs`

## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills psk-video-copywriter-docs`
