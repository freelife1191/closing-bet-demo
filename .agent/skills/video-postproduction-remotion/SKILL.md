---
name: video-postproduction-remotion
...
## Mission
Operate and verify the video-postproduction-remotion workflow with deterministic outputs.
...
## Quick Commands
- `./scripts/pipeline/run_stage.sh validate # placeholder for video-postproduction-remotion`

## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills video-postproduction-remotion`
