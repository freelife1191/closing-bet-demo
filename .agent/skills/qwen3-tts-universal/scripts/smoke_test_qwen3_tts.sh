...
[[ -n "${RUNNER_PATH}" ]] || RUNNER_PATH="${PROJECT_ROOT}/.agent/skills/qwen3-tts-universal/scripts/qwen3_tts_runner.py"
...
cat > "${CUSTOM_TEXT}" <<'TXT'
안녕하세요. 이 파일은 qwen3-tts-universal 스킬의 custom voice 스모크 테스트용 입력입니다.
