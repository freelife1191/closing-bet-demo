---
name: psk-playwright-scene-recorder
...
## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills psk-playwright-scene-recorder`
