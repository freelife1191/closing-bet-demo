...
RUNNER_PATH="${PROJECT_ROOT}/.agent/skills/psk-qwen3-tts-universal/scripts/qwen3_tts_runner.py"
...
if [[ "${WRITE_CONFIG}" == "true" ]]; then
  "${PROJECT_ROOT}/.agent/skills/psk-qwen3-tts-universal/scripts/init_qwen3_tts_config.sh" \
