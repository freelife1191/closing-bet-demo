...
## Quick Commands
- `./scripts/pipeline/run_stage.sh validate # placeholder for psk-video-qc-gatekeeper`

## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills psk-video-qc-gatekeeper`
