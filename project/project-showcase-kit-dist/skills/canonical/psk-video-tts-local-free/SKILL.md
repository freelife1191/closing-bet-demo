...
# psk-video-tts-local-free

## Mission
Operate and verify the psk-video-tts-local-free workflow with deterministic outputs.
...
## Verification
- `python3 scripts/skills/validate_skill_structure.py --skills psk-video-tts-local-free`
