...
_MEMORY_TABLES = ("chatbot_memories",)
...
def _prune_daily_suggestions_in_sqlite(
    ...
    try:
        def _probe_and_prune() -> bool:
            probe_rows = _load_daily_suggestions_rows_read_only(db_path_text)
...
def load_memories_from_sqlite(
    ...
    try:
        ...
        rows = run_chatbot_sqlite_with_recovery(
            db_path,
            logger,
            _load_rows,
            table_names=_MEMORY_TABLES,
