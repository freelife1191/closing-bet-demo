...
사용자의 재요청으로 NumPy2.4.6과 pykrx1.2.9+cookie.1 로컬 보안 수정 wheel을 설치해 전체검수를 완료했다. 필수9/9 통과로 이전N4 실패·N5 차단을 해소했다. 현재 기준과 결과는 [쿠키 수정·업그레이드 보고서](batch-numpy-cookie-fix-2026-09-21.md)를 따른다. 아래 BLOCKED 기록은 수정 전 공식판과 인코더 선행 작업의 이력이다.
