...
class Handler(BaseHTTPRequestHandler):
    ...
    def relay(self):
        ...
        target=57722 if path.startswith('/api/') or path.startswith('/__qa/') else 57721
...
ThreadingHTTPServer(('127.0.0.1',57720),Handler).serve_forever()
