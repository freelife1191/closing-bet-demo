...
command=['agent-browser','--headed','--namespace','performance-20260918','--session','qa','--profile',str(scratch/'browser-profile'),'--allowed-domains','127.0.0.1,cdnjs.cloudflare.com','--proxy','http://127.0.0.1:9','--proxy-bypass','127.0.0.1,cdnjs.cloudflare.com','--args','--disable-background-networking',*args]
try:
