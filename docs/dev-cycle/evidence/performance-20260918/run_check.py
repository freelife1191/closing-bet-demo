...
stage = sys.argv[1]
commands = {
 "mock": ([str(scratch/"venv/bin/python"),"-m","pytest","-q","tests/app/test_performance_mock_20260918.py"],scratch,90),
 "backend-regression": ([str(scratch/"venv/bin/python"),"-m","pytest","-q","tests/services/test_kr_market_backtest_service.py","tests/services/test_kr_market_cumulative_cache.py","tests/app/test_kr_market_data_ai_routes_refactor.py"],scratch,120),
 "fixture": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/performance-20260918/fixture_probe.py"),str(scratch/"docs/dev-cycle/evidence/performance-20260918/fixture.py")],scratch,60),
 "pytest": ([str(scratch/"venv/bin/python"),"-m","pytest","-q"],scratch,180),
 "backend": ([str(scratch/"venv/bin/python"),"-m","pytest","-q","tests/services/test_performance_batch_20260918.py"],scratch,90),
 "cumulative": (["npx","vitest","run","src/app/dashboard/kr/cumulative/CumulativeClientPage.regression-performance-batch.test.tsx"],scratch/"frontend",90),
 "presentation": (["npx","vitest","run","src/app/dashboard/kr/page.regression-performance-batch.test.tsx"],scratch/"frontend",90),
 "vitest": (["npx","vitest","run"],scratch/"frontend",300),
 "lint": (["npm","run","lint"],scratch/"frontend",90),
