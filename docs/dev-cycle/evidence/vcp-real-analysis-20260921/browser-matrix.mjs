...
const out='/Users/freelife/vibe/lecture/hodu/closing-bet-demo/docs/dev-cycle/evidence/vcp-real-analysis-20260921';
const results=[];
for(const mode of ['normal','legacy','raw','generated']) {
 await fetch('http://127.0.0.1:57992/__qa/control',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({mode})});
 await page.goto('http://127.0.0.1:57990/dashboard/kr/vcp');
