...
stage = sys.argv[1]
commands = {
 "bench": ([str(scratch/"venv/bin/python"), str(scratch/"docs/dev-cycle/evidence/vcp-real-analysis-20260921/performance_probe.py")],scratch,240),
 "snapshotprobe": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/vcp-real-analysis-20260921/snapshot_process_probe.py")],scratch,110),
 "fixture": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/vcp-real-analysis-20260921/fixture_probe.py")],scratch,60),
