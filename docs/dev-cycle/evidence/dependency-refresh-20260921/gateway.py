...
class Handler(BaseHTTPRequestHandler):
    ...
    def relay(self):
        ...
        target=58001 if path.startswith('/api/auth/') else (58002 if path.startswith('/api/') or path.startswith('/__qa/') else 58001)
...
ThreadingHTTPServer(('127.0.0.1',58000),Handler).serve_forever()
