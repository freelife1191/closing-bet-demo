...
class Handler(BaseHTTPRequestHandler):
    ...
    def relay(self):
        ...
        target=57952 if path.startswith('/api/') or path.startswith('/__qa/') else 57951
...
ThreadingHTTPServer(('127.0.0.1',57950),Handler).serve_forever()
