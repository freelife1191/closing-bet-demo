...
stage = sys.argv[1]
commands = {
 "bench": ([str(scratch/"venv/bin/python"), str(scratch/"docs/dev-cycle/evidence/infra-read-boundaries-20260921/performance_probe.py")],scratch,240),
 "snapshotprobe": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/infra-read-boundaries-20260921/snapshot_process_probe.py")],scratch,110),
 "fixture": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/infra-read-boundaries-20260921/fixture_probe.py")],scratch,60),
 "pytarget": ([str(scratch/"venv/bin/python"),"-m","pytest","-q", *sys.argv[2:]],scratch,120),
 "pytest": ([str(scratch/"venv/bin/python"),"-m","pytest","-q","-ra"],scratch,300),
...
if stage.split(":")[0] == "fixture":
    environment["INTERNAL_IDENTITY_SECRET"] = "qa-infra-synthetic-identity"
