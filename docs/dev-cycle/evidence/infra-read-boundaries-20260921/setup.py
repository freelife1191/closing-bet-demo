...
r=pathlib.Path.cwd(); e=r/'docs/dev-cycle/evidence/infra-read-boundaries-20260921'
s=pathlib.Path(tempfile.mkdtemp(prefix='infra-read-boundaries-20260921-')).resolve()
