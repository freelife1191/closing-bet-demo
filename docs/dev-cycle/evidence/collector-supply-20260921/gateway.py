...
class Handler(BaseHTTPRequestHandler):
    ...
    def relay(self):
        ...
        target=57942 if path.startswith('/api/') or path.startswith('/__qa/') else 57941
...
ThreadingHTTPServer(('127.0.0.1',57940),Handler).serve_forever()
