...
assert scratch.name.startswith('collector-supply-20260921-') and not (scratch/'.git').exists()
...
paths = changed + [p for p in new if p.startswith(('engine/','services/','frontend/src/','tests/','docs/dev-cycle/evidence/collector-supply-20260921/','docs/dev-cycle/plans/2026-09-21-quota','docs/dev-cycle/qa/'))]
