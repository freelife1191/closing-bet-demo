...
r=Path.cwd();e=r/'docs/dev-cycle/evidence/numpy-upgrade-20260921';s=Path(tempfile.mkdtemp(prefix='numpy-upgrade-20260921-')).resolve()
...
req=s/'requirements.txt';req.write_text(req.read_text().replace('numpy==1.26.4','numpy==2.4.6').replace('pykrx==1.2.3','pykrx==1.2.7'))
