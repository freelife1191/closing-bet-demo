...
stage = sys.argv[1]
commands = {
 "fixture": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/chat-ui-20260914/fixture_probe.py"),str(scratch)],scratch,60),
 "pytest": ([str(scratch/"venv/bin/python"),"-m","pytest","-q"],scratch,180),
 "chat": (["npx","vitest","run","src/app/chatbot/page.regression-chat-019-010.test.tsx"],scratch/"frontend",90),
 "vcp": (["npx","vitest","run","src/app/dashboard/kr/vcp/page.regression-chat-020.test.tsx"],scratch/"frontend",90),
