...
command=['agent-browser','--namespace','chat-ui-20260914','--session','qa','--profile',str(scratch/'browser-profile'),'--allowed-domains','127.0.0.1','--proxy','http://127.0.0.1:9','--proxy-bypass','127.0.0.1','--args','--disable-background-networking',*args]
try:
