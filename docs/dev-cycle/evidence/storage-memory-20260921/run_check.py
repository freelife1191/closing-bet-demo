...
stage = sys.argv[1]
commands = {
 "snapshotprobe": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/storage-memory-20260921/snapshot_process_probe.py")],scratch,110),
 "fixture": ([str(scratch/"venv/bin/python"),str(scratch/"docs/dev-cycle/evidence/storage-memory-20260921/fixture_probe.py")],scratch,60),
