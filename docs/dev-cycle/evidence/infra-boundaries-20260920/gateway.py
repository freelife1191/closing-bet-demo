...
class Handler(BaseHTTPRequestHandler):
    ...
    def relay(self):
        ...
        target=57822 if path.startswith('/api/') or path.startswith('/__qa/') else 57821
...
ThreadingHTTPServer(('127.0.0.1',57820),Handler).serve_forever()
