...
command=['agent-browser','--namespace','slash-20260909','--session','qa','--profile',str(scratch/'browser-profile'),'--allowed-domains','127.0.0.1','--proxy','http://127.0.0.1:9','--proxy-bypass','127.0.0.1','--args','--disable-background-networking',*args]
try:
