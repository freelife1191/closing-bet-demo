...
commands = {
    ...
    "stream": (["npx", "vitest", "run", "src/app/chatbot/useChatStream.regression-chat-013.test.tsx"], scratch / "frontend", 90),
    ...
    "case": ([str(scratch / "venv/bin/python"), str(scratch / "case_probe.py")], scratch, 30),
    "history": ([str(scratch / "venv/bin/python"), str(scratch / "docs/dev-cycle/evidence/slash-batch-20260909/history_probe.py"), str(scratch)], scratch, 60),
    "smoke": ([str(scratch / "venv/bin/python"), str(scratch / "docs/dev-cycle/evidence/slash-batch-20260909/fixture.py"), "--repo", str(scratch), "smoke"], scratch, 60),
    "target": ([str(scratch / "venv/bin/python"), "-m", "pytest", "tests/app/test_kr_market_route_integration.py", "tests/app/test_kr_market_chatbot_service.py", "tests/chatbot/test_storage_sqlite.py", "-q"], scratch, 180),
}
