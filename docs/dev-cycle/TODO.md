...
- 설계 승인: 2026-09-09 사용자 「승인」, 직전 CHAT-008·009 묶음 설계. 승인 확인 2026-09-09T22:10:15.676936+09:00 | T2 공유 검토. 진행: 구현·정적 검증 완료, ponytail SHIP/code-review APPROVE/architect WATCH(비차단). 종합 COMMENT로 QA 진행. 증거 `evidence/slash-batch-20260909/scope.md`.
...
- [ ] QA에서 확인한 익명 사용량 표시 불일치: Sidebar 사용량 GET에도 기존 세션 헤더를 전달하고, 전용 챗봇 EOF 뒤 기존 갱신 이벤트를 발행해 회귀·실측을 재실행한다.
