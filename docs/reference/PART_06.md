...
### frontend/src/app/globals.css (kr_market_package/frontend/src/app/globals.css)
```css
@import "tailwindcss";
...
### chatbot/core.py (kr_market_package/chatbot/core.py)
```python
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
### chatbot/prompts.py (kr_market_package/chatbot/prompts.py)
```python
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
