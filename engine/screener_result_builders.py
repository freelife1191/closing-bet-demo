...
def build_screening_result(
    *,
    ...
    return {
        ...
        "name": stock["name"],
        "score": total_score,
        "foreign_net_5d": supply_result.get("foreign_5d"),
        "inst_net_5d": supply_result.get("inst_5d"),
...
def build_signal_item(row: Any, signal_date: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "foreign_5d": getattr(row, "foreign_net_5d", None),
        "inst_5d": getattr(row, "inst_net_5d", None),
