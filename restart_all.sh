...
# PYTHONUNBUFFERED: 워커의 print(pykrx 로그인 등)가 버퍼에 쌓였다가 종료 때 한꺼번에 기록되면
# 로그 시각을 믿을 수 없다([INFRA-089])
PYTHONUNBUFFERED=1 lifecycle_exec_detached "$PROJECT_ROOT/venv/bin/gunicorn" flask_app:app \
